...
<acme:list readonly="true">
	...
	<acme:list-column code="anonymous.shout.list.label.xxx.xxx1" path="xxx.xxx1" width="60%"/>
	<acme:list-column code="anonymous.shout.list.label.xxx.money" path="xxx.money" width="60%"/>
	<acme:list-column code="anonymous.shout.list.label.xxx.flag" path="xxx.flag" width="60%"/>
</acme:list>