...
public class GenericSpamManagerTaskCreateTest extends AcmeWorkPlansTest{
	 ...
	 */
	@ParameterizedTest
	@CsvFileSource(resources = "/generic/spam/ManagerTaskPositive.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
	...
	/* 
		Esta test intenta crear tasks que no complen las validaciones de spam.
		Se espera un resultado negativo.
	*/
	@ParameterizedTest
	@CsvFileSource(resources = "/generic/spam/ManagerTaskNegative.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
